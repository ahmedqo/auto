            ...
            <form action="{{ route('actions.vehicles.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <neo-autocomplete set-query="{{ 'name_' . Core::lang() }}" set-value="id"
                        placeholder="{{ __('Brand') }} (*)" name="brand" value="{{ old('brand') }}"
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <neo-autocomplete set-query="{{ 'name_' . Core::lang() }}" set-value="id"
                        placeholder="{{ __('Model') }} (*)" name="model" value="{{ old('model') }}"
                        query="{{ old('model_name') }}">
                    </neo-autocomplete>
                </div>
                <div class="flex flex-col gap-1 lg:col-span-2">
                    <label class="text-sm text-x-black font-x-thin">
                ...
                <div class="flex flex-col gap-1 lg:col-span-2">
                    ...
                    <textarea id="description_en" name="description_en" placeholder="{{ __('Description') }}" rows="3">{{ old('description_en') }}</textarea>
                </div>
