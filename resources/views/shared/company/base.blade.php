...
<body close>
    ...
    <neo-wrapper class="bg-x-light isolate">
        ...
        <main class="w-full container mx-auto p-4 lg:max-w-[60%]">
            @yield('content')
        </main>
    </neo-wrapper>
