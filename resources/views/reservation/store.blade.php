...
@section('content')
    <div class="flex flex-col gap-2">
        ...
        <div class="bg-x-white rounded-x-thin shadow-x-core border border-x-shade p-6 lg:p-8">
            <form require action="{{ route('actions.reservations.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <neo-autocomplete set-query="name" set-value="id" placeholder="{{ __('Secondary Client') }}"
                            ...
                            <input type="hidden" name="secondary_client_name"
                                value="{{ old('secondary_client_name') }}" />
                        </neo-autocomplete>
                    </div>
                ...
                <div data-view="3" class="hidden w-full grid-rows-1 grid-cols-1 gap-6 lg:gap-8">
                    <div class="flex flex-col gap-1">
                        ...
                        <neo-datepicker require {{ !Core::lang('ar') ? 'full-day=3' : '' }}
                            placeholder="{{ __('Drop-off Date') }} (*)" name="to_date"
                ...
                <div data-view="5"
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <neo-textbox require type="number" placeholder="{{ __('Fuel') }}" name="fuel"
                            value="{{ old('fuel') }}"></neo-textbox>
                    </div>
                    <div class="flex flex-col gap-1">
                        <label class="text-sm text-x-black font-x-thin">
                            {{ __('State') }}
                        </label>
                        <div class="w-full border border-x-shade rounded-x-thin p-2 lg:p-4 bg-x-light">
