...
class Core
{
    ...
    public static function powerList()
    {
    ...
    {
        $today = Carbon::today();
        $alerts = Alert::with('Vehicle')->where('company', Core::company()->id)
    ...
    {
        return [
            "casablanca", "rabat", "fez", "marrakesh", "agadir", "tangier", "meknes", "oujda", "kenitra", "tetouan", "safi", "mohammedia", "khouribga", "el jadida", "nador", "beni mellal", "khemisset", "larache", "ksar el kebir", "settat", "sidi kacem", "temara", "berrechid", "oued zem", "fquih ben salah", "taroudant", "ouarzazate", "dakhla", "guelmim", "laayoune"
        ];
    }

    public static function consList()
    {
        return [
            'fluids' => [
                'engine oil',
    ...
    {
        return ['insurance 1', 'insurance 2', 'insurance 3'];
    }
