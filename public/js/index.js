...
Neo.Locales.ar = {
    ...
    "156 sportwagon": "156 سبورت واجن",
    "159 sportwagon": "159 سبورت واجن",
    "4c": "4 ج",
    "brera": "بريرا",
    "gtv": "gtv",
    "mito": "ميتو",
    ...
    "911 carrera cabrio": "911 كاريرا كابريو",
    "911 targa": "911 تارجا",
    "911 turbo": "911 توربو",
    "boxster": "بوكستر",
    "cayenne": "حريف",
    ...
    "310 van": "310 فان",
    "310 kombi": "310 كومبي",
    "230 - 300 ce coupé": "230 - 300 كوبيه",
    "260 - 560 se": "260 - 560 ثانية",
    "260 - 560 sel": "260 - 560 س",
    "500 - 600 sec coupé": "500 - 600 ثانية كوبيه",
    "trieda a": "تريدا أ",
    "a": "أ",
    "a l": "ل",
    ...
    "saab": "صعب",
    "9-3": "9-3",
    "9-3 cabriolet": "9-3 كابريوليه",
    "9-3 coupé": "9-3 كوبيه",
    "9-3 sportcombi": "9-3 سبورتكومبي",
    "9-5": "9-5",
    "9-5 sportcombi": "9-5 سبورتكومبي",
    "900 c": "900 ج",
    "900 c turbo": "900ج تيربو",
    "audi": "أودي",
    "100 avant": "100 مقدم",
    "80 avant": "80 مقدما",
    "80 cabrio": "80 كابريو",
...
Neo.Locales.fr = {
    ...
    "Model": "Modèle",
    "Year": "Année",
    "Circulation Date": "Date de circulation",
    "Transmission": "Transmission",
    "Fuel": "Carburant",
    "Horse Power": "Puissance",
    "Cost": "Coût",
    ...
    "911 carrera cabrio": "911 Carrera Cabriolet",
    "911 targa": "911 targa",
    "911 turbo": "911 turbo",
    "boxster": "boxeur",
    "cayenne": "Cayenne",
    ...
    "310 van": "fourgon 310",
    "310 kombi": "310 combi",
    "230 - 300 ce coupé": "230 - 300 ce coupé",
    "260 - 560 se": "260 - 560 secondes",
    "260 - 560 sel": "260 - 560 sels",
    "500 - 600 sec coupé": "500 - 600 secondes coupé",
    ...
    "saab": "saab",
    "9-3": "9-3",
    "9-3 cabriolet": "9-3 cabriolets",
    "9-3 coupé": "9-3 coupé",
    "9-3 sportcombi": "9-3 combi sport",
    "9-5": "9h à 17h",
    "9-5 sportcombi": "9-5 sportcombi",
    "900 c": "900 c",
    "900 c turbo": "900 ch turbo",
    "audi": "audi",
    "100 avant": "100 avant",
    "80 avant": "80 avant",
    "80 cabrio": "80 cabriolet",
    "a1": "a1",
    "a2": "a2",
    "a3": "a3",
    ...
    "chrysler": "chrysler",
    "300 c": "300 c",
    "300 c touring": "300 c en tournée",
    "300 m": "300 m",
    ...
    "transit custom": "douane de transit",
...
const Locale = document.documentElement.lang,
    ...
    COLS = {
        ...
        client_reservation: () => [{
            ...
            bodyRender: (row) => row.vehicle ? $cap(row.vehicle.brand) + ' ' + $cap(row.vehicle.model) + ' ' + row.vehicle.year + ' (' + $cap(row.vehicle.registration) + ")" : empty(),
            bodyPdfRender: function(row) {
                return this.bodyRender(row);
            },
            bodyCsvRender: function(row) {
