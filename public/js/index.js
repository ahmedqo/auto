...
Neo.Locales.fr = {
    ...
    "cooper s": "tonnelier",
    "cooper s cabrio": "Cooper Cabriolet",
...
const Locale = document.documentElement.lang,
    ...
    COLS = {
        ...
        order_reservation: () => [{
            ...
            name: "vehicle",
            text: $trans("Vehicle"),
            bodyRender: (row) => row.vehicle ? $cap($trans(row.vehicle.brand)) + ' ' + $cap($trans(row.vehicle.model)) + ' ' + row.vehicle.year + ' (' + $cap(row.vehicle.registration_number) + ")" : empty(),
            bodyPdfRender: function(row) {
                return this.bodyRender(row);
            },
            bodyCsvRender: function(row) {
        ...
        vehicles: ({
            ...
            bodyRender: (row) => $cap($trans(row.brand)) + " " + $cap($trans(row.model)) + " " + row.year + " (" + row.registration_number.toUpperCase() + ")",
            bodyPdfRender: function(row) {
                return this.bodyRender(row);
            },
            bodyCsvRender: function(row) {
